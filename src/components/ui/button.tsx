  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 outline-none focus-visible:ring-2 focus-visible:ring-ring",
  {
    variants: {
      variant: {
        ...
        // Azul digital — acción de interfaz (la primaria operativa del manual).
        blue: "bg-blue text-white shadow-xs hover:bg-blue/90",
        // Coral — acción destacada, una por vista (energía del manual).
        accent: "bg-coral text-white shadow-xs hover:bg-coral/90",
        destructive: "bg-destructive text-white shadow-xs hover:bg-destructive/90",
        outline: "border border-input bg-background shadow-xs hover:bg-accent hover:text-accent-foreground",
        // Outline azul — acción secundaria.
        "outline-blue": "border border-blue/40 bg-white text-blue shadow-xs hover:bg-[#EEF3FE]",
